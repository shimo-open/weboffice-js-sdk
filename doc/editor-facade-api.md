...
- docs 标准化入口：`sdk.ActiveOutline.Editor.Document`、`sdk.ActiveOutline.Reference`、`sdk.ActiveOutline.Service`、`sdk.ActiveOutline.Sub`、`sdk.ActiveOutline.Env`
...
| ------------ | ----------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| docs         | 标准化产品对象树                                | `sdk.ActiveOutline.Editor.*`、`sdk.ActiveOutline.Reference.*`、`sdk.ActiveOutline.Service.*`、`sdk.ActiveOutline.Sub.*`、`sdk.ActiveOutline.Env.*` | receiver `productJSAPI.*`；只在 docs 挂载                                             |
